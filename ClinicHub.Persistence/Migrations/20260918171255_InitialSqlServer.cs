        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxAds = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    MaxImpressions = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppointmentFeePercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 0m),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdPackageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxAdvanceBookingDays = table.Column<int>(type: "int", nullable: false, defaultValue: 30),
                    ReservationTtlMinutes = table.Column<int>(type: "int", nullable: false, defaultValue: 10),
                    CancellationWindowMinutes = table.Column<int>(type: "int", nullable: false, defaultValue: 120),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArDescription = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ...
                    ResponsibleDoctor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    WorkingDays = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Location = table.Column<Point>(type: "geography", nullable: false),
                    IsRegistered = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    IsSetupComplete = table.Column<bool>(type: "bit", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Active"),
                    SpecializationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Rating = table.Column<double>(type: "float", nullable: true),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClinicAdminId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacebookUserId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    GoogleUserId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ClinicId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            // SQL Server cannot b-tree index a geography column — dedicated spatial
            // index for the map/nearby queries (mirrors legacy AddSpatialIndexToClinic).
