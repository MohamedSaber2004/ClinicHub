namespace ClinicHub.Infrastructure.Services.Interfaces
{
    ...
    {
        Task<List<ClinicExternalDto>> GetNearbyFromMapAsync(double lat, double lng, string category, CancellationToken cancellationToken, double radius = 5000, string? languageCode = null);
        Task<List<ClinicExternalDto>> TextSearchAsync(string query, double? lat, double? lng, double radius, CancellationToken cancellationToken, string? languageCode = null);
