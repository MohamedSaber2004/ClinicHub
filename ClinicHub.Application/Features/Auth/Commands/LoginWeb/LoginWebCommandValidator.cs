...
{
    public class LoginWebCommandValidator : AbstractValidator<LoginWebCommand>
    {
        private readonly UserManager<ApplicationUser> _userManager;

        public LoginWebCommandValidator(UserManager<ApplicationUser> userManager, IStringLocalizer<Messages> localizer)
        {
