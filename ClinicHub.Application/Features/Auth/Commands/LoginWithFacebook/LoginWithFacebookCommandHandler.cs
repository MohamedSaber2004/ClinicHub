...
{
    public sealed class LoginWithFacebookCommandHandler : IRequestHandler<LoginWithFacebookCommand, AuthResponseDto>
    {
        ...
        public async Task<AuthResponseDto> Handle(LoginWithFacebookCommand request, CancellationToken cancellationToken)
        {
