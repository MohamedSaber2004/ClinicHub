...
{
    public class GetAllClinicsQueryValidator : AbstractValidator<GetAllClinicsQuery>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IStringLocalizer<Messages> _localizer;

        public GetAllClinicsQueryValidator(IUnitOfWork unitOfWork, IStringLocalizer<Messages> localizer)
        {
