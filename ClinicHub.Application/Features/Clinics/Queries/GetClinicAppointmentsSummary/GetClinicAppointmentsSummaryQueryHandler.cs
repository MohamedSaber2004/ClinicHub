...
{
    public class GetClinicAppointmentsSummaryQueryHandler
        : IRequestHandler<GetClinicAppointmentsSummaryQuery, List<AppointmentsSummaryPointDto>>
    {
        ...
        public GetClinicAppointmentsSummaryQueryHandler(IUnitOfWork unitOfWork, ICurrentUserService currentUserService)
        {
