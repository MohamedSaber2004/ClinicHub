...
{
    public class UnfollowClinicCommandValidator : AbstractValidator<UnfollowClinicCommand>
    {
        private readonly IUnitOfWork _unitOfWork;

        public UnfollowClinicCommandValidator(IStringLocalizer<Messages> localizer, IUnitOfWork unitOfWork)
        {
