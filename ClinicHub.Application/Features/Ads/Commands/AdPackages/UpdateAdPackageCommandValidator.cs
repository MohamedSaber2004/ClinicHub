...
public class UpdateAdPackageCommandValidator : AbstractValidator<UpdateAdPackageCommand>
{
    public UpdateAdPackageCommandValidator(IStringLocalizer<Messages> localizer)
    {
        RuleFor(v => v.Id)
