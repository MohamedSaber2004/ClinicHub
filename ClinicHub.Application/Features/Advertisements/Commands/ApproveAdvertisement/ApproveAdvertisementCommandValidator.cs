...
{
    public class ApproveAdvertisementCommandValidator : AbstractValidator<ApproveAdvertisementCommand>
    {
        private readonly IUnitOfWork _ctx;

        public ApproveAdvertisementCommandValidator(IStringLocalizer<Messages> localizer, IUnitOfWork ctx)
        {
            _ctx = ctx;

            RuleFor(v => v.AdvertisementId)
