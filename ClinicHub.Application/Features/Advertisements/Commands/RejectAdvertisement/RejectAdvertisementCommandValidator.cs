...
{
    public class RejectAdvertisementCommandValidator : AbstractValidator<RejectAdvertisementCommand>
    {
        private readonly IUnitOfWork _ctx;

        public RejectAdvertisementCommandValidator(IStringLocalizer<Messages> localizer, IUnitOfWork ctx)
        {
            _ctx = ctx;
