...
{
    public class GetClinicStaffByIdQueryValidator : AbstractValidator<GetClinicStaffByIdQuery>
    {
        private readonly UserManager<ApplicationUser> _userManager;

        public GetClinicStaffByIdQueryValidator(IStringLocalizer<Messages> localizer, UserManager<ApplicationUser> userManager)
        {
