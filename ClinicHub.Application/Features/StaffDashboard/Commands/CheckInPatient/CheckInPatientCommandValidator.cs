...
{
    public class CheckInPatientCommandValidator : AbstractValidator<CheckInPatientCommand>
    {
        private readonly IUnitOfWork _ctx;

        public CheckInPatientCommandValidator(IStringLocalizer<Messages> localizer, IUnitOfWork ctx)
        {
            _ctx = ctx;
