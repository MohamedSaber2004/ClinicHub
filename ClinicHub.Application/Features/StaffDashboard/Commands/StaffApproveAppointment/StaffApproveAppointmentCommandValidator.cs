...
{
    public class StaffApproveAppointmentCommandValidator : AbstractValidator<StaffApproveAppointmentCommand>
    {
        private readonly IUnitOfWork _ctx;

        public StaffApproveAppointmentCommandValidator(IStringLocalizer<Messages> localizer, IUnitOfWork ctx)
        {
            _ctx = ctx;
