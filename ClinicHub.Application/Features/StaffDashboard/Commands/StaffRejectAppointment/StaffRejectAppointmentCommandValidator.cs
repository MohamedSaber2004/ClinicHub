...
{
    public class StaffRejectAppointmentCommandValidator : AbstractValidator<StaffRejectAppointmentCommand>
    {
        private readonly IUnitOfWork _ctx;

        public StaffRejectAppointmentCommandValidator(IStringLocalizer<Messages> localizer, IUnitOfWork ctx)
        {
            _ctx = ctx;
